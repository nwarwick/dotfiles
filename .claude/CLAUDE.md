...
- Do not include Claude/AI references or co-author tags in commit messages
...
- I prefer to follow the conventions of the frameworks, tools, and libraries I am using
- I value readable code over super-optimized code
